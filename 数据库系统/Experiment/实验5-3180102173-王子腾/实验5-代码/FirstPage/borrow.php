...
<div class="row">
    <div class="col-md-4 order-md-1">
        <form class="form-signin " action="../SecondPage/Borrow.php" method="POST">
            ...
            <input type="id" id="inputEmail" class="form-control" placeholder="Book Number" name="bno" required autofocus>
            </label>
            <button class="btn btn-lg btn-primary btn-block" type="submit">Borrow</button>
        </form>
    </div>
